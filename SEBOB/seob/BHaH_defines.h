...
typedef struct __commondata_struct__ {
  REAL *restrict dynamics_fine;               // (nrpy.infrastructures.BHaH.seobnr.SEOBNRv5_aligned_spin_coefficients)
  ...
  REAL a6;                                    // (nrpy.infrastructures.BHaH.seobnr.SEOBNRv5_aligned_spin_coefficients)
  REAL a_1_NQC;                               // (nrpy.infrastructures.BHaH.seobnr.SEOBNRv5_aligned_spin_coefficients)
  REAL a_2_NQC;                               // (nrpy.infrastructures.BHaH.seobnr.SEOBNRv5_aligned_spin_coefficients)
  REAL a_3_NQC;                               // (nrpy.infrastructures.BHaH.seobnr.SEOBNRv5_aligned_spin_coefficients)
  REAL a_f;                                   // (nrpy.infrastructures.BHaH.seobnr.SEOBNRv5_aligned_spin_coefficients)
  REAL b_1_NQC;                               // (nrpy.infrastructures.BHaH.seobnr.SEOBNRv5_aligned_spin_coefficients)
  REAL b_2_NQC;                               // (nrpy.infrastructures.BHaH.seobnr.SEOBNRv5_aligned_spin_coefficients)
  REAL chi1;                                  // (nrpy.infrastructures.BHaH.seobnr.SEOBNRv5_aligned_spin_coefficients)
  REAL chi2;                                  // (nrpy.infrastructures.BHaH.seobnr.SEOBNRv5_aligned_spin_coefficients)
  REAL dHreal_dpphi;                          // (nrpy.infrastructures.BHaH.seobnr.SEOBNRv5_aligned_spin_coefficients)
  REAL dHreal_dpphi_circ;                     // (nrpy.infrastructures.BHaH.seobnr.SEOBNRv5_aligned_spin_coefficients)
  REAL dHreal_dprstar;                        // (nrpy.infrastructures.BHaH.seobnr.SEOBNRv5_aligned_spin_coefficients)
  REAL dHreal_dr;                             // (nrpy.infrastructures.BHaH.seobnr.SEOBNRv5_aligned_spin_coefficients)
  REAL dHreal_dr_circ;                        // (nrpy.infrastructures.BHaH.seobnr.SEOBNRv5_aligned_spin_coefficients)
  REAL dHreal_dr_dpphi;                       // (nrpy.infrastructures.BHaH.seobnr.SEOBNRv5_aligned_spin_coefficients)
  REAL dHreal_dr_dr;                          // (nrpy.infrastructures.BHaH.seobnr.SEOBNRv5_aligned_spin_coefficients)
  REAL dSO;                                   // (nrpy.infrastructures.BHaH.seobnr.SEOBNRv5_aligned_spin_coefficients)
  REAL dT;                                    // (nrpy.infrastructures.BHaH.seobnr.SEOBNRv5_aligned_spin_coefficients)
  REAL dt;                                    // (nrpy.infrastructures.BHaH.seobnr.SEOBNRv5_aligned_spin_coefficients)
  REAL flux;                                  // (nrpy.infrastructures.BHaH.seobnr.SEOBNRv5_aligned_spin_coefficients)
  REAL initial_omega;                         // (nrpy.infrastructures.BHaH.seobnr.SEOBNRv5_aligned_spin_coefficients)
  REAL m1;                                    // (nrpy.infrastructures.BHaH.seobnr.SEOBNRv5_aligned_spin_coefficients)
  REAL m2;                                    // (nrpy.infrastructures.BHaH.seobnr.SEOBNRv5_aligned_spin_coefficients)
  REAL mass_ratio;                            // (nrpy.infrastructures.BHaH.seobnr.SEOBNRv5_aligned_spin_coefficients)
  REAL nr_amp_1;                              // (nrpy.infrastructures.BHaH.seobnr.SEOBNRv5_aligned_spin_coefficients)
  REAL nr_amp_2;                              // (nrpy.infrastructures.BHaH.seobnr.SEOBNRv5_aligned_spin_coefficients)
  REAL nr_amp_3;                              // (nrpy.infrastructures.BHaH.seobnr.SEOBNRv5_aligned_spin_coefficients)
  ...
  REAL r;                                     // (nrpy.infrastructures.BHaH.seobnr.SEOBNRv5_aligned_spin_coefficients)
  REAL r_ISCO;                                // (nrpy.infrastructures.BHaH.seobnr.SEOBNRv5_aligned_spin_coefficients)
  REAL r_stop;                                // (nrpy.infrastructures.BHaH.seobnr.SEOBNRv5_aligned_spin_coefficients)
  REAL t_ISCO;                                // (nrpy.infrastructures.BHaH.seobnr.SEOBNRv5_aligned_spin_coefficients)
  ...
  double complex *restrict waveform_fine;     // (nrpy.infrastructures.BHaH.seobnr.SEOBNRv5_aligned_spin_coefficients)
  double complex *restrict waveform_inspiral; // (nrpy.infrastructures.BHaH.seobnr.SEOBNRv5_aligned_spin_coefficients)
  double complex *restrict waveform_low;      // (nrpy.infrastructures.BHaH.seobnr.SEOBNRv5_aligned_spin_coefficients)
  int NUMGRIDS;                               // (nrpy.grid)
  size_t nsteps_IMR;                          // (nrpy.infrastructures.BHaH.seobnr.SEOBNRv5_aligned_spin_coefficients)
  size_t nsteps_fine;                         // (nrpy.infrastructures.BHaH.seobnr.SEOBNRv5_aligned_spin_coefficients)
  size_t nsteps_inspiral;                     // (nrpy.infrastructures.BHaH.seobnr.SEOBNRv5_aligned_spin_coefficients)
  size_t nsteps_low;                          // (nrpy.infrastructures.BHaH.seobnr.SEOBNRv5_aligned_spin_coefficients)
  size_t nsteps_raw;                          // (nrpy.infrastructures.BHaH.seobnr.SEOBNRv5_aligned_spin_coefficients)
} commondata_struct;
