...
class EOB:
    ...
    def _flux(self, v, nu, constants):
        ...
        flux = (
            ...
            * nu
            * jnp.pow(v, 7)
            * (2 * F_6_l * jnp.pow(v, 6) * jnp.log(v / v_m) + 1)
            / (
                (-tmp0 * v + 1)
                * (
                    tmp0
                                        ...
                                        * v
                                        / (
                                            ...
                                            * (
                                                ...
                                                * tmp6
                                                * tmp64
                                                - F_7 * tmp130 * tmp22 * v_p
                                                - 24 * tmp0 * tmp124 * tmp15 * tmp42
                                                - 18 * tmp0 * tmp132 * tmp4
                                                - tmp0 * tmp138 * tmp37
                                                + tmp101
                                                + tmp103
                                                ...
                                                - tmp123 * tmp13 * tmp55
                                                - tmp123 * tmp18
                                                - 3 * tmp123 * ((tmp30) * (tmp30))
                                                - 6 * tmp123 * tmp31 * tmp78
                                                - 3 * tmp123 * tmp31
                                                - tmp123 * tmp33 * tmp66
                                                - tmp123 * tmp35
                                                - tmp123 * tmp44 * tmp72
                                                ...
                                                * (-5 * tmp0 + 5 * tmp2)
                                                - tmp123 * tmp74
                                                - 10 * tmp124 * tmp15 * tmp33
                                                - tmp124 * ((tmp30) * (tmp30) * (tmp30))
                                                - tmp124 * tmp31 * tmp48
                                                - tmp124 * tmp31 * (-tmp104 + 12 * tmp2)
                                                - 10 * tmp124 * tmp37 * tmp42
                                                - 4 * tmp124 * tmp37
                                                - 15 * tmp124 * tmp39 * tmp5
                                                - tmp124 * tmp42 * tmp46
                                                - 18 * tmp124 * tmp42 * tmp57
                                                - tmp124 * tmp46
                                                - 12 * tmp124 * tmp57
                                                - 4 * tmp124 * tmp70
                                                - tmp125 * tmp55
                                                ...
                                                * tmp130
                                                - 30 * tmp130 * tmp15 * tmp5
                                                - tmp130 * tmp22 / jnp.pow(v_p, 6)
                                                - 5 * tmp130 * tmp51
                                                - 5 * tmp130 * tmp91
                                                - tmp131 * tmp44
                                                - tmp131 * tmp77
                                                ...
                                                * (
                                                ...
                                                - 15 * tmp134 * tmp4 * tmp51
                                                - tmp134 * tmp48 * tmp91
                                                - tmp136 * tmp48
                                                - tmp136 * (-tmp115 + 9 * tmp2)
                                                - tmp138 * tmp17 * tmp21
                                                - tmp138 * tmp21 * tmp4
                                                - tmp2
                                                - tmp29
    ...
    def _circular_orbit_finder(self, r0, params, tol=1e-12, max_iter=100):
        ...
        def body(carry):
            i, r0, _ = carry
            f, df = jax.value_and_grad(self._circular_orbit_condition, argnums=0)(
                r0, params
            )
            return (i + 1, r0 - f / df, f)
